            ...
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                ...
                <div class="panel-body">
                  <form action="{{route('kategori.index')}}" method="post" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                  <input name="_method" type="hidden" value="PATCH">
          {{csrf_field()}}
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Nama</label>
                      <div class="col-sm-6">
                       <label class="col-sm-3 control-label">{{$kategoris->name}}</label>
                      </div>
                    </div>
                     ...
                     <div class="form-group">
                      <label class="col-sm-3"></label>
                       <a href="{{ URL::previous() }}" type="button" class="btn btn-default md-close">Kembali</a>
                        ...
                        <!-- <button type="submit" class="btn btn-primary md-close">Kembali</button> -->
                     </div>
